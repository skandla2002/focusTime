...
## Completed Issue List (Moved From plan.md)
...
- ISSUE-047: 통계 탭 전면 광고 1시간 쿨다운 — 최초 진입 후 1시간 내 재진입 시 광고 생략
- ISSUE-048: 하단 배너 광고 레이아웃 수정 — 배너(최하단) 위에 GNB 항상 표시
- ISSUE-049: 타이머 잠금 버튼 — 텍스트('잠금'/'잠금 해제') → 열쇠 아이콘(🔒/🔓)으로 교체
- ISSUE-050: 잠금 상태에서 '시작'/'계속' 버튼 활성화 — 타이머 제어 버튼은 잠금 예외
